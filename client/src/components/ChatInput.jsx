    ...
    <div className="w-full overflow-hidden px-3 md:px-5 py-4 border-t border-white/6 bg-[#0d0f14]">
      <div className="flex flex-col gap-2 bg-white/8 border border-white/7 rounded-2xl px-4 pt-3.5 pb-3">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            className="flex items-center justify-center w-8 h-8 rounded-lg border border-none cursor-pointer transition-all duration-150 bg-linear-to-br from-indigo-500
             to-violet-700 hover:opacity-90 text-white"
          >
            <Send size={15} />
          </button>
        </div>
