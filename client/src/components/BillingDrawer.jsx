...
import { createOrder, verifyPayment } from "../features/billing";

export const BillingDrawer = ({ open, onClose }) => {
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-screen z-50 w-95 bg-[#0f11117] border-l border-white/10 shadow-2xl flex flex-col"
          >
              ...
              <div className=" rounded-xl bg-white/10 border border-white/10 p-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <h3 className="text-white text-xlfont-bold">
                      {userData.plan || "free"}
                    </h3>
                  </div>
            ...
            <div className="px-5 flex-1 overflow-auto space-y-4 scrollbar-none">
